...
export default function Page() {
    ...
    void Promise.all([
      ...
      setParties(
        Array.isArray(partyData)
          ? partyData.filter((party: Party) => party.partyType === "CUSTOMER")
          : [],
      );
  ...
  return (
    <div className="mx-auto max-w-6xl">
      <h1 className="text-3xl font-bold">বিক্রি / POS</h1>
      <p className="mt-2 text-slate-500">
        Complete sales flow with automatic stock and party balance updates.
      </p>
